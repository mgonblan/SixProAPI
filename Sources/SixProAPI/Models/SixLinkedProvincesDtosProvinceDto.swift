//
// SixLinkedProvincesDtosProvinceDto.swift
//
...
public struct SixLinkedProvincesDtosProvinceDto: Codable, Hashable {
    ...
    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, name: String? = nil, shortName: String? = nil, countryId: UUID? = nil, cities: [SixLinkedCitiesDtosCityDto]? = nil) {
        self.id = id
