//
// SixLinkedUsersDtosExtendedIdentityUserDto.swift
//
...
public struct SixLinkedUsersDtosExtendedIdentityUserDto: Codable, Hashable {
    ...
    public init(extraProperties: [String: AnyCodable]? = nil, id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, tenantId: UUID? = nil, userName: String? = nil, name: String? = nil, surname: String? = nil, email: String? = nil, emailConfirmed: Bool? = nil, phoneNumber: String? = nil, phoneNumberConfirmed: Bool? = nil, lockoutEnabled: Bool? = nil, lockoutEnd: Date? = nil, concurrencyStamp: String? = nil, profilePictureId: UUID? = nil) {
