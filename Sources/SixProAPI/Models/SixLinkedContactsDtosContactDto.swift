//
// SixLinkedContactsDtosContactDto.swift
//
...
public struct SixLinkedContactsDtosContactDto: Codable, Hashable {
    ...
    public var contactUser: SixLinkedUsersDtosSimpleUserDto?
    public var contactCompany: SixLinkedCompaniesDtosContactCompanyDto?
    public var type: SixLinkedContactsContactType?

    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, userId: UUID? = nil, companyId: UUID? = nil, contactUser: SixLinkedUsersDtosSimpleUserDto? = nil, contactCompany: SixLinkedCompaniesDtosContactCompanyDto? = nil, type: SixLinkedContactsContactType? = nil) {
        self.id = id
