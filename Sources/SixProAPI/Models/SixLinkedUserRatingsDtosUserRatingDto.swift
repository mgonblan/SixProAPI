//
// SixLinkedUserRatingsDtosUserRatingDto.swift
//
...
public struct SixLinkedUserRatingsDtosUserRatingDto: Codable, Hashable {
    ...
    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, ratingUserId: UUID? = nil, profileId: UUID? = nil, profile: SixLinkedProfilesDtosProfileDto? = nil, title: String? = nil, description: String? = nil) {
        self.id = id
