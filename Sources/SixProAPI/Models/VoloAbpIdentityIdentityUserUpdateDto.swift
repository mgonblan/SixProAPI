//
// VoloAbpIdentityIdentityUserUpdateDto.swift
//
...
public struct VoloAbpIdentityIdentityUserUpdateDto: Codable, Hashable {
    ...
    public init(extraProperties: [String: AnyCodable]? = nil, userName: String, name: String? = nil, surname: String? = nil, email: String, phoneNumber: String? = nil, lockoutEnabled: Bool? = nil, roleNames: [String]? = nil, password: String? = nil, concurrencyStamp: String? = nil) {
