//
// SixLinkedRequirementsDtosRequirementDto.swift
//
...
public struct SixLinkedRequirementsDtosRequirementDto: Codable, Hashable {
    ...
    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, publicationId: UUID? = nil, type: SixLinkedRequirementsRequirementType? = nil, name: String? = nil, description: String? = nil) {
        self.id = id
