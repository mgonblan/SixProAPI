...
public struct SixLinkedTasksTask: Codable, Hashable {
    ...
    public var project: SixLinkedProjectsProject?
    ...
    public init(id: UUID? = nil, extraProperties: [String: AnyCodable]? = nil, concurrencyStamp: String? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, project: SixLinkedProjectsProject? = nil, projectId: UUID? = nil, title: String? = nil, description: String? = nil, dueDate: Date? = nil, assignedUserId: UUID? = nil) {
        self.id = id
