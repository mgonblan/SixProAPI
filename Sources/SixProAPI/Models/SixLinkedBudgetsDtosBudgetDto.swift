//
// SixLinkedBudgetsDtosBudgetDto.swift
//
...
public struct SixLinkedBudgetsDtosBudgetDto: Codable, Hashable {
    ...
    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, publicationId: UUID? = nil, minQuantity: Double? = nil, maxQuantity: Double? = nil, type: SixLinkedBudgetsBudgetType? = nil) {
        self.id = id
