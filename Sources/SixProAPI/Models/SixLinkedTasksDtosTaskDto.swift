//
// SixLinkedTasksDtosTaskDto.swift
//
...
public struct SixLinkedTasksDtosTaskDto: Codable, Hashable {
    ...
    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, projectId: UUID? = nil, title: String? = nil, description: String? = nil, dueDate: Date? = nil, assignedUserId: UUID? = nil) {
        self.id = id
