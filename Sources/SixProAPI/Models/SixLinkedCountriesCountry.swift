//
// SixLinkedCountriesCountry.swift
//
...
public struct SixLinkedCountriesCountry: Codable, Hashable {
    ...
    public var provinces: [SixLinkedProvincesProvince]?

    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, name: String? = nil, shortName: String? = nil, provinces: [SixLinkedProvincesProvince]? = nil) {
        self.id = id
