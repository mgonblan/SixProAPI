//
// SixLinkedPublicationsDtosPublicationDto.swift
//
...
public struct SixLinkedPublicationsDtosPublicationDto: Codable, Hashable {
    ...
    public var company: SixLinkedCompaniesDtosCompanyDto?
    ...
    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, company: SixLinkedCompaniesDtosCompanyDto? = nil, budget: SixLinkedBudgetsDtosBudgetDto? = nil, category: SixLinkedCategoriesDtosCategoryDto? = nil, companyId: UUID? = nil, title: String? = nil, slug: String? = nil, description: String? = nil, content: String? = nil, publicationStartDate: Date? = nil, publicationEndDate: Date? = nil, projectStartDate: Date? = nil, projectEndDate: Date? = nil, isPublic: Bool? = nil, isAnonymous: Bool? = nil, categoryId: UUID? = nil, status: SixLinkedPublicationsStatus? = nil, visibilityType: SixLinkedPublicationsVisibilityType? = nil, publicationType: SixLinkedPublicationsPublicationType? = nil, budgetId: UUID? = nil, requirements: [SixLinkedRequirementsDtosRequirementDto]? = nil) {
        self.id = id
