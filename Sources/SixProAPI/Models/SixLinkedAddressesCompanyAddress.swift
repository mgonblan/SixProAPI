//
// SixLinkedAddressesCompanyAddress.swift
//
...
public struct SixLinkedAddressesCompanyAddress: Codable, Hashable {
    ...
    public init(id: UUID? = nil, creationTime: Date? = nil, creatorId: UUID? = nil, lastModificationTime: Date? = nil, lastModifierId: UUID? = nil, isDeleted: Bool? = nil, deleterId: UUID? = nil, deletionTime: Date? = nil, companyId: UUID? = nil, company: SixLinkedCompaniesCompany? = nil, addressId: UUID? = nil) {
        self.id = id
